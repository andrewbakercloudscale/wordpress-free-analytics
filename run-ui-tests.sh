...
KEY="/Users/cp363412/Desktop/github/CPT_Default_Key.pem"
HOST="ec2-user@ec2-15-240-13-91.af-south-1.compute.amazonaws.com"
...
# ── Generate WordPress auth cookies via PHP ────────────────────────────────────
