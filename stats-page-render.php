...
function cspv_render_insights_tab( $vars ) {
    extract( $vars, EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract -- admin-only, all keys are trusted internal names
    ?>
    <!-- ═══════════════════════ INSIGHTS TAB ════════════════════════ -->
...
function cspv_render_display_tab( $vars ) {
    extract( $vars, EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract -- admin-only, all keys are trusted internal names
    ?>
    <!-- ═══════════════════════ DISPLAY TAB ═════════════════════════ -->
...
function cspv_render_throttle_tab( $vars ) {
    extract( $vars, EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract -- admin-only, all keys are trusted internal names
    ?>
    <!-- ═══════════════════════ THROTTLE TAB ════════════════════════ -->
...
function cspv_render_stats_page_js( $vars ) {
    extract( $vars, EXTR_SKIP ); // phpcs:ignore WordPress.PHP.DontExtract.extract_extract -- admin-only, all keys are trusted internal names
